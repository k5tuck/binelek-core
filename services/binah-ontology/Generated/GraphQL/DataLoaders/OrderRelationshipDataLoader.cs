...
{
    /// <summary>
    /// DataLoader for batch loading relationships for Order entities
    /// Prevents N+1 query problems when resolving relationship metadata
    /// </summary>
    public class OrderRelationshipDataLoader : BatchDataLoader<string, IEnumerable<string>>
    {
        private readonly IOrderRepository _repository;

        public OrderRelationshipDataLoader(
        ...
        {
            // Batch fetch all relationships for the given Order IDs
