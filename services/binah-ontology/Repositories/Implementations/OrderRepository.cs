    ...
    public class OrderRepository : IOrderRepository
    {
        ...
        public async Task<Order> CreateAsync(Order entity, string tenantId)
        {
            ...
            try
            {
                ...
                return MapToOrder(result["e"].As<Neo4j.Driver.INode>());
            }
            catch (Exception ex)
            {
        ...
        public async Task<IEnumerable<Order>> GetAllAsync(string tenantId, int skip = 0, int limit = 100)
        {
            ...
            try
            {
                ...
                return results.Select(record => MapToOrder(record["e"].As<Neo4j.Driver.INode>())).ToList();
            }
            catch (Exception ex)
            {
        ...
        public async Task<Order> UpdateAsync(Order entity, string tenantId)
        {
            ...
            try
            {
                var result = await session.ExecuteWriteAsync(async tx =>
                {
                    ...
                    if (record == null) throw new InvalidOperationException("Order not found");
                    return record;
                });
        ...
        public async Task DeleteAsync(Guid id, string tenantId)
        {
            ...
            try
            {
                await session.ExecuteWriteAsync(async tx =>
                {
                    ...
                    if (result == null) throw new InvalidOperationException("Order not found");
                    return result;
                });
            }
            catch (Exception ex)
        ...
        public async Task<OrderWithRelationships?> GetWithRelationshipsAsync(Guid id, string tenantId)
        {
            ...
            try
            {
                ...
                {
                    Entity = MapToOrder(result["e"].As<Neo4j.Driver.INode>()),
        ...
        private Order MapToOrder(Neo4j.Driver.INode node)
        {
            return new Order
            {
