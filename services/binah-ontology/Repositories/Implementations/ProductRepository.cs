    ...
    public class ProductRepository : IProductRepository
    {
        ...
        public async Task<Product> CreateAsync(Product entity, string tenantId)
        {
            ...
            try
            {
                ...
                return MapToProduct(result["e"].As<Neo4j.Driver.INode>());
            }
            catch (Exception ex)
            {
        ...
        public async Task<IEnumerable<Product>> GetAllAsync(string tenantId, int skip = 0, int limit = 100)
        {
            ...
            try
            {
                ...
                return results.Select(record => MapToProduct(record["e"].As<Neo4j.Driver.INode>())).ToList();
            }
            catch (Exception ex)
            {
        ...
        public async Task<Product> UpdateAsync(Product entity, string tenantId)
        {
            ...
            try
            {
                var result = await session.ExecuteWriteAsync(async tx =>
                {
                    ...
                    if (record == null) throw new InvalidOperationException("Product not found");
                    return record;
                });
        ...
        public async Task DeleteAsync(Guid id, string tenantId)
        {
            ...
            try
            {
                await session.ExecuteWriteAsync(async tx =>
                {
                    ...
                    if (result == null) throw new InvalidOperationException("Product not found");
                    return result;
                });
            }
            catch (Exception ex)
        ...
        public async Task<ProductWithRelationships?> GetWithRelationshipsAsync(Guid id, string tenantId)
        {
            ...
            try
            {
                ...
                {
                    Entity = MapToProduct(result["e"].As<Neo4j.Driver.INode>()),
        ...
        private Product MapToProduct(Neo4j.Driver.INode node)
        {
            return new Product
            {
